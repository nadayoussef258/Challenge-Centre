...
activeStep: number | null = null;
  ...
  steps = [
    ...
    },
    {
      ...
      desc: '  يقوم خبراؤنا في النطق والسلوك والتربية الخاصة برحلةاستكشافية مرحة (التقييم الشامل) لاكتشاف مكامن القوة والمواهب الكامنة في بطلكم — قبل التحديات، نرى الإمكانيات ـ تحت إشراف وتوجيه الأخصائي النفسي.',
      color: '#3d3da8',
    ...
    },
    {
      ...
      desc: 'نصمم معاً "ثوباً تربوياً" مُفصلاً لاحتياجات بطلكم. أهداف ذكية (SMART) محددة زمنياً، ضمن الخطة التربوية التأهيلية الفردية للطفل بمشاركة الأسرة في كل خطوة — لأن التكامل بين المركز والمنزل هو سر النجاح.',
      color: '#1e1e6a',
    ...
    },
    {
      ...
      short: 'حيث يبدأ التأقلم والتعلم',
      desc: 'يفتح المركز ذراعيه لاستقبال بطله الجديد. بيئة محفزة تجمع اللعب والتكنولوجيا والابتكار — أسبوعان من الملاحظة الذكية لضمان أعلى مستويات التكيّف والتأقلم قبل الانطلاق الكامل.',
      color: '#2D2D8E',
      cta: 'جولة في عالمنا'
    },
    {
